  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Assessment Library</h1>
          <p className="text-muted-foreground">Browse and filter psychological assessments</p>
        </div>
        <Button>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Assessment domains</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Assessment platforms</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Average administration time</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Assessments by platform</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Search and filter available assessments</CardDescription>
            </div>
                ...
                <CardContent>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span>{assessment.minAge}-{assessment.maxAge} years</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Subtests:</span>
